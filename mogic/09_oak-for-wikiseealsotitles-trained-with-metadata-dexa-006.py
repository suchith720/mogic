...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/09_oak-for-wikiseealsotitles-trained-with-metadata-dexa-006'
    ...
    model = OAK005.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', batch_size=100, num_batch_labels=5000, 
                               ...
                               num_metadata=block.train.dset.meta['lnk_meta'].n_meta, num_metadata_clusters=block.train.dset.meta['lnk_meta'].n_meta,
