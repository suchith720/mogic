...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/17_entity-ngame-linker-for-msmarco-004'
    config_file = 'configs/msmarco-entity.json'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/msmarco_data-meta_distilbert-base-uncased_xcs.pkl'
    if build_block:
