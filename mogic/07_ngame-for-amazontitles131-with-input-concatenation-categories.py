...
if __name__ == '__main__':
    ...
    def combine_info(title_toks, title_mask, meta_toks, meta_mask, sep_tok):
        ...
        for title, title_mask, meta, meta_mask in zip(title_toks, title_mask, meta_toks, meta_mask):
            ...
            all_toks.append(t[:255] + [sep_tok])
            all_mask.append(m[:255] + [sep_tok])
        return all_toks, all_mask

    """ Load data """

    pkl_file = f'{pkl_dir}/processed/amazontitles131_data_distilbert-base-uncased_xcs_{meta_type}-256.pkl'
    if build_block:
