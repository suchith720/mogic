...
def load_config(fname):
    with open(fname, 'r') as f:
        return json.load(f)['data_entity1']

# %% ../nbs/00_ngame-for-wikiseealsotitles-with-input-concatenation.ipynb 26
if __name__ == '__main__':
    build_block = False
    pkl_dir = '/home/aiscuser/scratch1/datasets/'
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/17_ngame-for-entity-msmarco-with-input-concatenation-001'
    config_file = 'configs/msmarco-entity.json'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/msmarco_data-entity1_distilbert-base-uncased_xcs_aug-ent-256.pkl'
    if build_block:
        config = load_config(config_file)
        block = XCBlock.from_cfg(config, transform_type='xcs', tokenizer='distilbert-base-uncased', 
                main_max_data_sequence_length=32, main_max_lbl_sequence_length=128, 
                meta_max_sequence_length=32, sampling_features=[('lbl2data',1)], oversample=False)
