...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/17_ngame-for-msmarco-002'
    config_file = 'configs/msmarco.json'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/msmarco_data_distilbert-base-uncased_xcs_64.pkl'
    if build_block:
        config = load_config(config_file)
        block = SXCBlock.from_cfg(config, tokenizer="distilbert-base-uncased", padding=True,
                                  return_tensors='pt', main_max_sequence_length=64, n_slbl_samples=1, main_oversample=False,
