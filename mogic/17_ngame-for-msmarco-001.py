...
if __name__ == '__main__':
    ...
    """ Load data """
    pkl_file = f'{pkl_dir}/processed/msmarco_data_distilbert-base-uncased_xcs.pkl'
    if build_block:
        config = load_config(config_file)
        block = SXCBlock.from_cfg(config, tokenizer="distilbert-base-uncased", padding=True,
                                  return_tensors='pt', main_max_sequence_length=32, n_slbl_samples=1, main_oversample=False,
