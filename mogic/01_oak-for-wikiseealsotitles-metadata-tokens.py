# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_oak-for-wikiseealsotitles-metadata-tokens.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/01_oak-for-wikiseealsotitles-metadata-tokens.ipynb 2
import os,torch, torch.multiprocessing as mp, pickle, numpy as np, math
from transformers import DistilBertConfig

from xcai.basics import *
from xcai.models.oakY import OAK001, OAK002

from xclib.utils.sparse import retain_topk

from fastcore.utils import *

# %% ../nbs/01_oak-for-wikiseealsotitles-metadata-tokens.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT']='oak_00-wikiseealsotitles'

# %% ../nbs/01_oak-for-wikiseealsotitles-metadata-tokens.ipynb 8
if __name__ == '__main__':
    build_block = False
    pkl_dir = '/home/scai/phd/aiz218323/scratch/datasets/'
    data_dir = '/home/scai/phd/aiz218323/Projects/XC_NLG/data'
    
    output_dir = '/home/scai/phd/aiz218323/scratch/outputs/medic/01_oak-for-wikiseealsotitles-metadata-tokens'
    ...
    args = XCLearningArguments(
        ...
        label_names=['lbl2data_idx', 'lbl2data_input_ids', 'lbl2data_attention_mask', 'lnk2data_idx', 
                     'lnk2data_input_ids', 'lnk2data_attention_mask', 'lnk2data_data2ptr'],
