...
if __name__ == '__main__':
    build_block = False
    dataset = 'amazontitles131'

    data_dir = '/data/From_B/'
    pkl_dir = '/home/aiscuser/scratch1/datasets/'
    output_dir = '/home/aiscuser/scratch1/outputs/medic/00_benchmarking-distilbert-base-uncased'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/{dataset}_data_distilbert-base-uncased_xcs.pkl'
    if build_block:
        block = XCBlock.from_cfg('data', data_dir, dset=dataset, transform_type='xcs', tokenizer='distilbert-base-uncased', 
