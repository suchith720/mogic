...
def fuse_meta_into_embeddings(self:Encoder003, embed:torch.Tensor, meta_kwargs:Dict):
    ...
    for m_key, m_args in meta_kwargs.items():
        ...
        if len(idx):
            ...
            meta_repr[m_key] = torch.zeros((0, dim), dtype=embed.dtype, device=embed.device)
...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/16_oak-for-hyperlink-abstract-wikiseealsotitles-with-metadata-encoder-001'
    ...
    if build_block:
        ...
        block = XCBlock.from_cfg(config, transform_type='xcs', tokenizer='distilbert-base-uncased', 
                                 sampling_features=[('lbl2data',1), ('hab2data',5)], oversample=False)
    ...
    args = XCLearningArguments(
        ...
        label_names=['lbl2data_idx', 'lbl2data_input_ids', 'lbl2data_attention_mask', 'hab2data_idx', 'hab2data_input_ids', 'hab2data_attention_mask'],
