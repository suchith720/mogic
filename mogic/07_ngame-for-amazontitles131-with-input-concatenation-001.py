...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/medic/07_ngame-for-amazontitles131-with-input-concatenation-001'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/amazontitles131_data_distilbert-base-uncased_xcs.pkl'
    if build_block:
