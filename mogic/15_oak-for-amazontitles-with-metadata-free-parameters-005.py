...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/15_oak-for-amazontitles-with-metadata-free-parameters-005'
    meta_embed_file = '/data/OGB_Weights/LF-AmazonTitles-131K/rev_emb_weights.npy'
    ...
    block.train.dset.meta['rev_meta'].meta_info = None
    block.test.dset.meta['rev_meta'].meta_info = None
    ...
    args = XCLearningArguments(
        ...
        label_names=['lbl2data_idx', 'lbl2data_input_ids', 'lbl2data_attention_mask', 'rev2data_idx'],
    ...
    model = OAK004.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', batch_size=bsz, num_batch_labels=5000, 
                                   ...
                                   num_metadata=block.train.dset.meta['rev_meta'].n_meta, 
                                   
                                   calib_margin=0.05, calib_num_negatives=10, calib_tau=0.1, calib_apply_softmax=False, 
                                   calib_loss_weight=1.0, use_calib_loss=True,
