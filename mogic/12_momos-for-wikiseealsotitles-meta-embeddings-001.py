...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/12_momos-for-wikiseealsotitles-meta-embeddings-001'
    ...
    m_student.set_meta_embeddings(torch.tensor(meta_embeddings, dtype=torch.float32))
