...
from xcai.models.oakX import OAK007
...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/04_oak-for-wikiseealsotitles-with-nvembed-metadata-002'
    meta_embed_file = '/home/aiscuser/scratch1/outputs/mogic/03_benchmarking-nvembed-004/meta_repr.pth'
    ...
    model = OAK007.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', batch_size=bsz, num_batch_labels=5000, 
                                   margin=0.3, num_negatives=10, tau=0.1, apply_softmax=True,
                               
                                   data_aug_meta_prefix='lnk2data', lbl2data_aug_meta_prefix=None, 
                                   data_pred_meta_prefix=None, lbl2data_pred_meta_prefix=None,
                                   
                                   num_metadata=block.train.dset.meta['lnk_meta'].n_meta, resize_length=5000, metadata_dim=4096, 
    ...
    model.encoder.init_embedding_projector()
