...
def load_config(fname, data_type):
    with open(fname, 'r') as file:
        return json.load(file)[data_type]
...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/18_llama1-entity-ngame-linker-for-msmarco-001'
    config_file = 'configs/msmarco-llama1-entity.json'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/msmarco_data-llama1-entity_distilbert-base-uncased_xcs.pkl'
    if build_block:
        config = load_config(config_file, 'data_llama1_entity')
