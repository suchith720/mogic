...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/16_ngame-for-abstract-wikiseealsotitles-with-input-concatenation-003'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/wikiseealsotitles_data-abs_distilbert-base-uncased_xcs_abs-256.pkl'
    if build_block:
        ...
        block = XCBlock.from_cfg(config, transform_type='xcs', tokenizer='distilbert-base-uncased', 
                                 sampling_features=[('lbl2data',1)], main_max_data_sequence_length=256, oversample=False)
