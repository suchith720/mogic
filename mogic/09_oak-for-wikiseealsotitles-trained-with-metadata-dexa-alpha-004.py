# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/09_oak-for-wikiseealsotitles-trained-with-metadata-dexa.ipynb.

# %% auto 0
__all__ = ['get_meta_cluster_mapping']

# %% ../nbs/09_oak-for-wikiseealsotitles-trained-with-metadata-dexa.ipynb 2
import os,torch, torch.multiprocessing as mp, pickle, numpy as np, math, transformers
from transformers import DistilBertConfig

from xcai.basics import *
from xcai.models.oakY import OAK006
...
# %% ../nbs/09_oak-for-wikiseealsotitles-trained-with-metadata-dexa.ipynb 4
os.environ['CUDA_VISIBLE_DEVICES'] = '12,13'
os.environ['WANDB_PROJECT']='oakVn_00-wikiseealsotitles'

# %% ../nbs/09_oak-for-wikiseealsotitles-trained-with-metadata-dexa.ipynb 6
@patch
...
# %% ../nbs/09_oak-for-wikiseealsotitles-trained-with-metadata-dexa.ipynb 8
def get_meta_cluster_mapping(meta_embeddings:torch.Tensor, cluster_sz:int=3):
    clusters = BalancedClusters.proc(meta_embeddings.half(), min_cluster_sz=cluster_sz)

    meta_cluster_mapping = torch.zeros(meta_embeddings.shape[0], dtype=torch.int64)
    for i,o in enumerate(clusters): meta_cluster_mapping[o] = i

    return meta_cluster_mapping, len(clusters)
    

# %% ../nbs/09_oak-for-wikiseealsotitles-trained-with-metadata-dexa.ipynb 9
if __name__ == '__main__':
    build_block = False
    pkl_dir = '/home/aiscuser/scratch1/datasets/'
    data_dir = '/data/datasets/'
    
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/09_oak-for-wikiseealsotitles-trained-with-metadata-dexa-alpha-004'
    ...
    meta_cluster_mapping, num_metadata_clusters = get_meta_cluster_mapping(meta_embeddings, cluster_sz=10)
    ...
    model = OAK006.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', batch_size=100, num_batch_labels=5000, 
                               ...
                               num_metadata=block.train.dset.meta['lnk_meta'].n_meta, num_metadata_clusters=num_metadata_clusters,
