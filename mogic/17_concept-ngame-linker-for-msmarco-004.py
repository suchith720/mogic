...
import os,torch,json, torch.multiprocessing as mp, pickle, numpy as np
...
if __name__ == '__main__':
    ...
    output_dir = '/home/aiscuser/scratch1/outputs/mogic/17_concept-ngame-linker-for-msmarco-004'
    config_file = 'configs/msmarco-concept.json'

    """ Load data """
    pkl_file = f'{pkl_dir}/processed/msmarco_data-concept_distilbert-base-uncased_xcs.pkl'
    if build_block:
    ...
    linker_block = block.linker_dset('cpt_meta')

    block.train.dset.data.n_slbl_samples = 100
    block.train.dset.meta.cpt_meta.n_sdata_meta_samples = 100
    batch = block.train.dset.__getitems__([303601])

    for k,v in batch.items():
        if 'text' in k: print(f'{k}: {v}')
